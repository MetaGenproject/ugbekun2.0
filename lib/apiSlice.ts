...
export const endpoints = {
  ...
  public: {
    branding: `${BASE_URL}/public/tenant/branding`,
    homepage: `${BASE_URL}/public/tenant/homepage`,
    schools: `${BASE_URL}/public/tenant/schools`,
    schoolInfo: `${BASE_URL}/public/tenant/school-info`,
    resolveDomain: `${BASE_URL}/public/tenant/resolve-domain`,
  },
  ...
  admin: {
    ...
    parentMessages: (parentId: number | string) => `${BASE_URL}/admin/parents/${parentId}/messages`,
    sendParentMessage: (parentId: number | string) => `${BASE_URL}/admin/parents/${parentId}/messages`,
    updateParentMessage: (messageId: number | string) => `${BASE_URL}/admin/parent-messages/${messageId}`,
    deleteParentMessage: (messageId: number | string) => `${BASE_URL}/admin/parent-messages/${messageId}`,
    sendParentBroadcast: `${BASE_URL}/admin/parents/broadcast`,
    ...
    sectionDetail: (id: number | string) => `${BASE_URL}/admin/sections/${id}`,
    allocateSections: `${BASE_URL}/admin/classes/allocate-sections`,
    subjects: `${BASE_URL}/admin/subjects`,
    subjectDetail: (id: number | string) => `${BASE_URL}/admin/subjects/${id}`,
    ...
    searchParents: (query: string) => `${BASE_URL}/admin/parents/search?query=${encodeURIComponent(query)}`,
    uploadStudentPhoto: (id: number) => `${BASE_URL}/admin/students/${id}/upload-photo`,
    uploadParentPhoto: (id: number) => `${BASE_URL}/admin/parents/${id}/upload-photo`,
    ...
    timetable: (classId?: number, sectionId?: number, teacherId?: number, sessionId?: number) =>
      `${BASE_URL}/admin/timetable?${classId ? `classId=${classId}` : ''}${sectionId ? `&sectionId=${sectionId}` : ''}${teacherId ? `&teacherId=${teacherId}` : ''}${sessionId ? `&sessionId=${sessionId}` : ''}`,
    ...
    timetablePublish: `${BASE_URL}/admin/timetable/publish`,
    timetableSessions: `${BASE_URL}/admin/timetable/sessions`,
    ...
    feeGroupAllocate: (id: number) => `${BASE_URL}/admin/finances/fee-groups/${id}/allocate`,
    ...
    officeTransactionItem: (id: number) => `${BASE_URL}/admin/finances/office-transactions/${id}`,
    officeTransactionVoid: (id: number) => `${BASE_URL}/admin/finances/office-transactions/${id}/void`,
  ...
  teacher: {
    ...
    classesSections: `${BASE_URL}/teacher/classes-sections`,
    classes: `${BASE_URL}/teacher/classes`,
    subjects: `${BASE_URL}/teacher/subjects`,
    subjectStudents: (assignId: number) => `${BASE_URL}/teacher/subjects/${assignId}/students`,
    ...
    reminders: `${BASE_URL}/teacher/reminders`,
    toggleReminder: (id: number) => `${BASE_URL}/teacher/reminders/${id}/toggle`,
    createReminder: `${BASE_URL}/teacher/reminders`,
    deleteReminder: (id: number) => `${BASE_URL}/teacher/reminders/${id}`,
    messages: `${BASE_URL}/teacher/messages`,
    sendMessage: `${BASE_URL}/teacher/messages`,
    gradebookCsvUpload: `${BASE_URL}/teacher/gradebook/csv-upload`,
    timetable: (sessionId?: number) => `${BASE_URL}/teacher/timetable${sessionId ? `?sessionId=${sessionId}` : ''}`,
  ...
  student: {
    ...
    homeworkDetail: (homeworkId: number) => `${BASE_URL}/student/homeworks/${homeworkId}`,
    ...
    teachers: `${BASE_URL}/student/teachers`,
    invoices: `${BASE_URL}/student/invoices`,
    timetable: `${BASE_URL}/student/timetable`,
    reminders: `${BASE_URL}/student/reminders`,
    toggleReminder: (id: number) => `${BASE_URL}/student/reminders/${id}/toggle`,
    createReminder: `${BASE_URL}/student/reminders`,
    deleteReminder: (id: number) => `${BASE_URL}/student/reminders/${id}`,
  ...
  parent: {
    ...
    messages: `${BASE_URL}/parent/messages`,
    sendMessage: `${BASE_URL}/parent/messages`,
    profile: `${BASE_URL}/parent/profile`,
    updateProfile: `${BASE_URL}/parent/profile`,
    changePassword: `${BASE_URL}/parent/change-password`,
  },
};
